...
<form method="post" action="/OnlineAuctionSystem/placeAuction" class="row g-3 needs-validation" novalidate>
    <div class="col-md-6">
...
<div class="col-12">
    <a href="../../viewListingsForUpdateAndDelete?id=placeAuction" class="btn btn-primary" type="submit">back To Place Auction</a>
</div>
