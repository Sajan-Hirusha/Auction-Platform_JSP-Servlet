...
<html>
    ...
    <body>
            ...
            if ("POST".equalsIgnoreCase(request.getMethod())) {
                ...
                try {
                    if (item.updateItem()) {
                        ...
                        response.sendRedirect("error.jsp?message=" + URLEncoder.encode("Failed to update item", "UTF-8"));
                    }
                } catch (Exception e) {
        ...
        <div class="col-12">
            <a href="viewItems.jsp" class="btn btn-primary" type="submit">back To Update</a>
        </div>
