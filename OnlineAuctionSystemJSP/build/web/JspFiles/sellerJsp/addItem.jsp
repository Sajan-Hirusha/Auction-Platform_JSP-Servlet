...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
       <link rel="stylesheet" href="../../CSS/AddItem_1.css">
</head>
<body >

<form method="post" action="/OnlineAuctionSystem/addListing" id="addItemForm" class="row g-3 needs-validation mt-5 px-2 px-md-0  py-2 mx-auto w-50" enctype="multipart/form-data" novalidate style="border:2px red solid ; ">
    <div class="col-md-5 mx-md-3" >
    ...
    <div class="col-12 col-md-10 mx-md-3">
